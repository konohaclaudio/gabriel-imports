    ...
    <main class="flex-1 overflow-y-auto p-8">
        ...
        <div class="flex justify-between items-center mb-8 border-b border-[#333] pb-4">
            <h1 class="text-3xl font-bold text-white">
                Preços <span class="text-[#C8A165]">/ <?= $barbeiro['nome'] ?></span>
            </h1>
                ...
                <table class="min-w-full text-sm text-left">
                    <thead class="bg-[#0A0A0A] text-xs uppercase text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 w-1/4">Preço Padrão Sugerido</th>
                            <th scope="col" class="px-6 py-3 w-1/4">Preço para <?= $barbeiro['apelido'] ?> (R$)</th>
                        </tr>
                    </thead>
                    <tbody>
