    ...
    <main class="flex-1 overflow-y-auto p-8">
        ...
        <div class="flex justify-between items-center mb-8 border-b border-[#333] pb-4">
            <h1 class="text-3xl font-bold text-white">
                Matriz de Preços <span class="text-[#C8A165]">/ <?= $barbeiro['nome'] ?></span>
            </h1>
        ...
        <?php if(isset($_GET['success'])): ?>
            <div class="bg-green-900/30 text-green-400 p-4 rounded-lg mb-6 border border-green-800/50">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full text-sm text-left">
                    <thead class="bg-[#0A0A0A] text-xs uppercase text-gray-400">
                        <tr>
                            <th scope="col" class="px-6 py-3 w-1/2">Serviço (Lista Mestra)</th>
                    ...
                    <tbody>
                        <?php if (empty($servicosPrecos)): ?>
                            <tr class="border-b border-[#333]">
                                <td colspan="3" class="px-6 py-4 text-center text-gray-500">
                                    Nenhum serviço mestre cadastrado. <a href="<?= BASE_URL ?>servicos" class="text-[#C8A165] hover:underline">Cadastre um serviço primeiro!</a>
                                </td>
                            </tr>
                        <?php endif; ?>
